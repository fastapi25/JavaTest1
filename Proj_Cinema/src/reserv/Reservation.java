...
//findById()- 입력변수와 일치하는 예매정보를 찾고, 이를 예매객체로 변환
...
//예매 정보 삭제 - 전달된 대표값을 reservations.txt파일에서 찾아 해당 행을 삭제
...
//예매 검색과 저장 -특정 영화와 관련된 모든 예매 정보를 반환
// reservations.txt파일로 부터 행 단위 문자열을 읽어와, 특정 영화와 관련된 예매정보를 검색
// 검색된 예매 정보는 객체가 되어 ArrayList에 담겨 반환
