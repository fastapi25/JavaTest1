...
//(1)영화 예매(좌석)
    private void reserve() {
        try {
            ArrayList<Movie> movies = Movie.findAll();//영화 목록 출력
            ...
            Movie m = Movie.findById(movieIdStr);//예매 영화 선택
            
            ArrayList<Reservation> reservations =//예매 영화의 좌석 현황 출력
            ...
            Reservation r = new Reservation(//예매 객체 저장
